...
use dashcore::{BlockHash, Target, CompactTarget};
...
impl CheckpointManager {
    ...
    pub fn last_checkpoint(&self) -> Option<&Checkpoint> {
        self.sorted_heights.last()
            .and_then(|height| self.checkpoints.get(height))
    }
    ...
    pub fn validate_header(&self, height: u32, block_hash: &BlockHash, merkle_root: Option<&BlockHash>) -> bool {
...
pub fn mainnet_checkpoints() -> Vec<Checkpoint> {
    vec![
        ...
        Checkpoint {
            height: 4991,
            block_hash: parse_block_hash("000000003b01809551952460744d5dbb8fcbd6cbae3c220267bf7fa43f837367").unwrap(),
            timestamp: 1390163520,
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0fffff)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000000000000271027f0".to_string(),
        ...
        Checkpoint {
            height: 9918,
            block_hash: parse_block_hash("00000000213e229f332c0ffbe34defdaa9e74de87f2d8d1f01af8d121c3c170b").unwrap(),
            timestamp: 1390344765,
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0fffff)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000000000000b5b3b5bf".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 16912,
            block_hash: parse_block_hash("00000000075c0d10371d55a60634da70f197548dbbfa4123e12abfcbc5738af9").unwrap(),
            timestamp: 1390821265,
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0fffff)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000000000001086108a1".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 45479,
            block_hash: parse_block_hash("000000000063d411655d590590e16960f15ceea4257122ac430c6fbe39fbf02d").unwrap(),
            timestamp: 1391836907,
            target: Target::from_compact(CompactTarget::from_consensus(0x1c2ac4af)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000002c7875c78875f".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 107996,
            block_hash: parse_block_hash("00000000000a23840ac16115407488267aa3da2b9bc843e301185b7d17e4dc40").unwrap(),
            timestamp: 1395522898,
            target: Target::from_compact(CompactTarget::from_consensus(0x1b04864c)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000056bf9caa56bf9d".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 312645,
            block_hash: parse_block_hash("0000000000059dcb71ad35a9e40526c44e7aae6c99169a9e7017b7d84b1c2daf").unwrap(),
            timestamp: 1407621730,
            target: Target::from_compact(CompactTarget::from_consensus(0x1b345f4c)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000017d08c8717d08c89".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 750000,
            block_hash: parse_block_hash("00000000000000b4181bbbdddbae464ce11fede5d0292fb63fdede1e7c8ab21c").unwrap(),
            timestamp: 1491953700,
            target: Target::from_compact(CompactTarget::from_consensus(0x1a075a02)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000485f01ee9f01ee9f8".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
...
pub fn testnet_checkpoints() -> Vec<Checkpoint> {
    vec![
        ...
        Checkpoint {
            height: 0,
            block_hash: parse_block_hash("00000bafbc94add76cb75e2ec92894837288a481e5c005f6563d91623bf8bc2c").unwrap(),
            timestamp: 1390666206,
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0ffff0)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000000000100010001".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        ...
        Checkpoint {
            height: 255,
            block_hash: parse_block_hash("0000080b600e06f4c07880673f027210f9314575f5f875fafe51971e268b886a").unwrap(),
            timestamp: 1390668900, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0fffff)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000000000200020002".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 1999,
            block_hash: parse_block_hash("00000052e538d27fa53693efe6fb6892a0c1d26c0235f599171c48a3cce553b1").unwrap(),
            timestamp: 1390700000, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1e0fffff)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000000000fa0fa0fa0fa".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 96090,
            block_hash: parse_block_hash("00000000033df4b94d17ab43e999caaf6c4735095cc77703685da81254d09bba").unwrap(),
            timestamp: 1392000000, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1c0168fd)),
            merkle_root: None,
            chain_work: "0x00000000000000000000000000000000000000000000000000059f8a5f8a5f8a".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 200000,
            block_hash: parse_block_hash("000000001015eb5ef86a8fe2b3074d947bc972c5befe32b28dd5ce915dc0d029").unwrap(),
            timestamp: 1394000000, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1b342be5)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000030f5830f5830f5".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 470000,
            block_hash: parse_block_hash("0000009303aeadf8cf3812f5c869691dbd4cb118ad20e9bf553be434bafe6a52").unwrap(),
            timestamp: 1500000000, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1a1c3bbe)),
            merkle_root: None,
            chain_work: "0x000000000000000000000000000000000000000000000000072f17072f17072f".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
        Checkpoint {
            height: 794950,
            block_hash: parse_block_hash("000001860e4c7248a9c5cc3bc7106041750560dc5cd9b3a2641b49494bcff5f2").unwrap(),
            timestamp: 1600000000, // Approximate
            target: Target::from_compact(CompactTarget::from_consensus(0x1a0b47cf)),
            merkle_root: None,
            chain_work: "0x0000000000000000000000000000000000000000000000000c1e270c1e270c1e".to_string(),
            masternode_list_name: None,
            include_merkle_root: false,
            protocol_version: None,
        },
...
mod tests {
    ...
    fn test_checkpoint_validation() {
        ...
        // Test validation
        let genesis_hash = parse_block_hash("00000ffd590b1485b3caadc19b22e6379c733355108f107a430458cdf3407ab6").unwrap();
