...
mod tests {
    ...
    fn test_validation_mode_none_always_passes() {
        ...
        let prev_header = create_test_header(
            dashcore::BlockHash::from_raw_hash(dashcore_hashes::hash_x11::Hash::from_byte_array([1; 32])),
            1,
            0x1e0fffff,
            1234567890,
        );
    ...
    fn test_validate_chain_basic_broken_chain() {
        ...
        let header3 = create_test_header(
            dashcore::BlockHash::from_raw_hash(dashcore_hashes::hash_x11::Hash::from_byte_array([99; 32])), // Broken link
            3,
            0x1e0fffff,
            1234567910,
        );
