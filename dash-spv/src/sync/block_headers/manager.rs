...
mod tests {
    ...
    fn create_test_manager() -> TestBlockHeadersManager {
    ...
    #[test]
    fn test_headers_manager_progress() {
    ...
    #[test]
    fn test_headers_manager_has_pipeline() {
        let manager = create_test_manager();
