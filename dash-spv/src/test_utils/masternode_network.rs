...
impl MasternodeTestContext {
        ...
        F: FnMut(&DashCoreNode, u32),
    {
        ...
        // Initial connectivity: wait for LLMQ_TEST connections to serve as the
        // base peer-connectivity gate, then for the rotating-quorum peers.
        ...
        // Phase 1 for q_0 (cycle start block).
        ...
        // Advance to the q_1 init block (cycle_start + 1).
        ...
        // Mine one more block to absorb any commitment that is still sitting
        // in the mempool, then confirm on-chain that the expected number of
        // quorums landed. Commitments are mined into phase blocks once the
        // mining window opens, so polling the minable-commitment queue here
        // would usually miss them.
        self.bump_mocktime(1);
