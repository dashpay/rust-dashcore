...
pub struct DashCoreConfig {
    ...
    pub rpc_port: u16,
    /// Additional command-line arguments passed to dashd
...
impl DashCoreConfig {
    ...
    /// Append additional command-line arguments passed to dashd on startup.
...
impl DashCoreNode {
    ...
    /// Get a new address from the node's configured wallet.
