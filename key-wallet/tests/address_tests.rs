...
fn test_address_parsing() {
    ...
    let parsed_mainnet = Address::<dashcore::address::NetworkUnchecked>::from_str(&mainnet_str).unwrap();
    ...
    let parsed_testnet = Address::<dashcore::address::NetworkUnchecked>::from_str(&testnet_str).unwrap();
