...
impl MasternodeListEngine {
    ...
    pub fn verify_is_lock(
        ...
        // Debug logging to trace verification values
        tracing::debug!(
            "verify_is_lock: txid={}, request_id={}, quorum_index={}, quorum_hash={}, cycle_hash={}",
            instant_lock.txid,
            hex::encode(request_id.to_byte_array()),
            quorum_index,
        ...
        tracing::debug!("verify_is_lock: sign_id={}", hex::encode(sign_id.to_byte_array()));
