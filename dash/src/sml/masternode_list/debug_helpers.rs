...
impl<'a> std::fmt::Debug for MasternodeList {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("MasternodeList")
            ...
            .field("masternode_merkle_root", &self.masternode_merkle_root.unwrap_or(MerkleRootMasternodeList::from_byte_array([0u8; 32])))
            .field("llmq_merkle_root", &self.llmq_merkle_root.unwrap_or(MerkleRootQuorums::from_byte_array([0u8; 32])))
