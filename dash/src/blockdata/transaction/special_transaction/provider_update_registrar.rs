...
mod tests {
    ...
    fn test_provider_update_registrar_transaction() {
        ...
        assert_eq!(operator_key_hex, expected_provider_update_registrar_payload.operator_public_key.encode_hex::<String>());

        let voting_key_hash_hex = "6cc4a7bb877a80c11ae06b988d98305773f93b98";
        assert_eq!(voting_key_hash_hex, expected_provider_update_registrar_payload.voting_key_hash.encode_hex::<String>());
