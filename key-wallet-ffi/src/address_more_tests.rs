...
mod more_tests {
    ...
    fn test_address_validate_valid() {
        ...
        let _is_valid = address_validate(addr_str.as_ptr(), FFINetwork::Testnet, &mut error);
    ...
    fn test_address_validate_null() {
        ...
        let is_valid = address_validate(ptr::null(), FFINetwork::Testnet, &mut error);
    ...
    fn test_address_get_type_valid() {
        ...
        let addr_str = CString::new("yXdxAYfK7KGx7gNpVHUfRsQMNpMj5cAadG").unwrap();
        let addr_type = address_get_type(addr_str.as_ptr(), FFINetwork::Testnet, &mut error);
    ...
    fn test_address_get_type_null() {
        ...
        let addr_type = address_get_type(ptr::null(), FFINetwork::Testnet, &mut error);
    ...
    fn test_wallet_derive_receive_address() {
        ...
        let wallet = wallet::wallet_create_random(FFINetwork::Testnet, &mut error);
        assert!(!wallet.is_null());

        // Derive receive address
        let address = wallet_derive_receive_address(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
            0, // address_index
    ...
    fn test_wallet_derive_change_address() {
        ...
        let address = wallet_derive_change_address(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
            0, // address_index
    ...
    fn test_wallet_get_all_addresses() {
        ...
        let success = wallet_get_all_addresses(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
            &mut addresses_out,
    ...
    fn test_wallet_get_address_at_index() {
        ...
        let address = wallet_get_address_at_index(
            wallet,
            FFINetwork::Testnet,
            0,     // account_index
            false, // is_change
    ...
    fn test_wallet_mark_address_used_with_address() {
        ...
        let address = wallet_derive_receive_address(wallet, FFINetwork::Testnet, 0, 0, &mut error);
    ...
    fn test_wallet_mark_address_used_null_wallet() {
        ...
        let success = wallet_mark_address_used(
            ptr::null_mut(),
            FFINetwork::Testnet,
            address.as_ptr(),
            &mut error,
