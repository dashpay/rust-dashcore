...
mod address_tests {
    ...
    fn test_address_derivation() {
        ...
        let receive_addr = address::wallet_derive_receive_address(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
            0, // address_index
    ...
    fn test_change_address_generation() {
        ...
        let change_addr = address::wallet_derive_change_address(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
            0, // address_index
    ...
    fn test_address_at_index() {
        ...
        let addr = address::wallet_get_address_at_index(
            wallet,
            FFINetwork::Testnet,
            0,     // account_index
            false, // is_change
        ...
        let change_addr = address::wallet_get_address_at_index(
            wallet,
            FFINetwork::Testnet,
            0,    // account_index
            true, // is_change
    ...
    fn test_multiple_address_generation() {
        ...
        for i in 0..5 {
            let addr = address::wallet_derive_receive_address(
                wallet,
                FFINetwork::Testnet,
                0, // account_index
                i, // address_index
    ...
    fn test_address_validation() {
        ...
        let is_valid = address::address_validate(valid_addr.as_ptr(), FFINetwork::Testnet, error);
        assert!(is_valid);

        // Test invalid address
        let invalid_addr = CString::new("invalid_address").unwrap();
        let is_valid = address::address_validate(invalid_addr.as_ptr(), FFINetwork::Testnet, error);
        assert!(!is_valid);
        assert_eq!(unsafe { (*error).code }, FFIErrorCode::InvalidAddress);

        // Test null address
        let is_valid = address::address_validate(ptr::null(), FFINetwork::Testnet, error);
        assert!(!is_valid);
    ...
    fn test_address_get_type() {
        ...
        let addr_type = address::address_get_type(p2pkh_addr.as_ptr(), FFINetwork::Testnet, error);
        assert_eq!(unsafe { (*error).code }, FFIErrorCode::Success);
    ...
    fn test_wallet_mark_address_used() {
        ...
        let success = address::wallet_mark_address_used(wallet, FFINetwork::Testnet, addr, error);
        assert!(success);
    ...
    fn test_wallet_get_all_addresses() {
        ...
        // Get all addresses
        let success = address::wallet_get_all_addresses(
            wallet,
            FFINetwork::Testnet,
            0, // account_index
