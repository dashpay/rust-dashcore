...
### Header Generation
The C header is auto-generated by the build script via the `ffi-header-gen` workspace crate. To regenerate all FFI headers manually:
```bash
cargo run -p ffi-header-gen
```
