...
typedef struct FFIBlocksProgress {
  enum FFISyncState state;
  uint32_t last_processed_height;
  uint32_t requested;
  uint32_t from_storage;
  uint32_t downloaded;
  uint32_t processed;
  uint32_t relevant;
  uint32_t transactions_found;
  uint64_t last_activity_secs;
} FFIBlocksProgress;
...
typedef struct FFISyncProgress {
  ...
  struct FFIBlockHeadersProgress *filter_headers;
...
typedef struct FFISpvStats {
  ...
  uint64_t blocks_with_relevant_transactions;
  uint64_t masternode_diffs_processed;
  uint64_t bytes_received;
  uint64_t bytes_sent;
  uint64_t uptime;
  uint64_t filters_requested;
  uint64_t filters_received;
  uint32_t active_filter_requests;
  uint32_t pending_filter_requests;
  uint64_t filter_request_timeouts;
  uint64_t filter_requests_retried;
} FFISpvStats;
