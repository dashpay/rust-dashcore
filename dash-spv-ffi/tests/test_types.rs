...
mod tests {
    ...
    fn test_sync_progress_conversion() {
        ...
        headers.set_state(SyncState::Initializing);
        ...
        filter_headers.update_current_height(200);
        ...
        filters.update_current_height(300);
        filters.update_target_height(200);
        filters.add_downloaded(30);
        filters.add_processed(25);
        ...
        blocks.add_downloaded(10);
        blocks.add_processed(8);
        blocks.add_relevant(12);
        ...
        masternodes.update_target_height(200);
        masternodes.add_diffs_processed(1);
        ...
        chainlocks.update_pending(200);
        chainlocks.add_processed(10);
        ...
        unsafe {
            ...
            assert_eq!(filter_headers.state, FFISyncState::Syncing);
            assert_eq!(filter_headers.current_height, 200);
            assert_eq!(filter_headers.target_height, 200);
            assert_eq!(filter_headers.processed, 40);
        }
        ...
        unsafe {
            ...
            assert_eq!(filters.state, FFISyncState::Syncing);
            assert_eq!(filters.current_height, 300);
            assert_eq!(filters.target_height, 200);
            assert_eq!(filters.downloaded, 30);
            assert_eq!(filters.processed, 25);
        ...
        unsafe {
            ...
            assert_eq!(blocks.last_processed_height, 400);
            assert_eq!(blocks.requested, 20);
            assert_eq!(blocks.from_storage, 5);
            assert_eq!(blocks.downloaded, 15);
            assert_eq!(blocks.processed, 20);
            assert_eq!(blocks.relevant, 8);
            assert_eq!(blocks.transactions_found, 12);
        }
        ...
        unsafe {
            ...
            assert_eq!(masternodes.target_height, 100);
            assert_eq!(masternodes.diffs_processed, 5);
        }
        ...
        unsafe {
            ...
            assert_eq!(chainlocks.state, FFISyncState::Synced);
            assert_eq!(chainlocks.best_validated_height, 600);
            assert_eq!(chainlocks.pending, 2);
            assert_eq!(chainlocks.processed, 10);
        }
        ...
        unsafe {
            ...
            assert_eq!(instantsend.state, FFISyncState::Synced);
            assert_eq!(instantsend.pending, 700);
            assert_eq!(instantsend.processed, 15);
        }
