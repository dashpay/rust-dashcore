use crate::{
    null_check, set_last_error, FFIClientConfig, FFIErrorCode, FFIEventCallbacks, FFISpvStats,
    FFISyncProgress, FFIWalletManager,
};
...
/// Sync the SPV client to the chain tip with manager-based progress updates.
///
/// This function uses the new parallel sync system with per-manager progress reporting.
///
/// # Safety
///
