...
- Preserve restored wallet block-spend evidence through ChainLock and sync
  checkpoint pruning so missing transaction history cannot resurrect spent coins.
